...
RUN apt-get update && apt-get install -y --no-install-recommends build-essential python3-pip libbz2-dev libsdl1.2-dev liblzma-dev libcurl4-openssl-dev zlib1g-dev libxml2-dev r-cran-tidyverse trf && rm -rf /var/lib/apt/lists/*
