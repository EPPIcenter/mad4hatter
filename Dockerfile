...
RUN Rscript -e 'remotes::install_cran(c("ggbeeswarm", "gridExtra", "rmarkdown", "foreach", "doMC", "argparse", "logger"), upgrade = "never", version = c("0.6.1", "2.3", "2.17", "1.5.2", "1.3.8", "2.1.6", "0.2.2"))'
