...
def main(args):
    ...
    if args.add_locus_column:
        df_microhap_collapsed_sort_columns, df_microhap_collapsed_sort_order = ['SampleID', 'Gene', 'SortPosition', 'Locus'], [True, True, True, True]
    else:
        df_microhap_collapsed_sort_columns, df_microhap_collapsed_sort_order = ['SampleID', 'Gene', 'SortPosition'], [True, True, True]
    ...
    df_microhap_collapsed.drop('SortPosition', axis=1, inplace=True)
